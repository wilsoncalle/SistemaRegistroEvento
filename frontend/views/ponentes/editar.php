...
$ponente = mysqli_fetch_assoc($resultado);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        mysqli_stmt_bind_param($stmt, 'sssssssi', 
            ...
            $especializacion, $biografia, $imagen_perfil, $ponente_id
        );
        
        if (!mysqli_stmt_execute($stmt)) {
            throw new Exception("Error al actualizar el ponente");
        }
...
<head>
    ...
    <title>Editar Ponente - Sistema de Gestión de Eventos Académicos</title>
                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="nombre" name="nombre" 
                                               value="<?php echo isset($ponente['nombre']) ? htmlspecialchars($ponente['nombre']) : ''; ?>" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="apellido" name="apellido" 
                                               value="<?php echo isset($ponente['apellido']) ? htmlspecialchars($ponente['apellido']) : ''; ?>" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email" 
                                           value="<?php echo isset($ponente['email']) ? htmlspecialchars($ponente['email']) : ''; ?>" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="tel" class="form-control" id="telefono" name="telefono" 
                                           value="<?php echo isset($ponente['telefono']) ? htmlspecialchars($ponente['telefono']) : ''; ?>">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="especializacion" name="especializacion" 
                                           value="<?php echo isset($ponente['especializacion']) ? htmlspecialchars($ponente['especializacion']) : ''; ?>" required>
                                    <div class="invalid-feedback">Por favor ingresa la especialización del ponente.</div>
                                </div>

                                <div class="mb-3">
                                    <label for="biografia" class="form-label">Biografía *</label>
                                    <textarea class="form-control" id="biografia" name="biografia" rows="4" required><?php echo isset($ponente['biografia']) ? htmlspecialchars($ponente['biografia']) : ''; ?></textarea>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="url" class="form-control" id="imagen_perfil" name="imagen_perfil" 
                                           value="<?php echo isset($ponente['imagen_perfil']) ? htmlspecialchars($ponente['imagen_perfil']) : ''; ?>"
